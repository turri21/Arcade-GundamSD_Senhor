...
// sdram_bridge — Bridge e arbitro SDRAM per GundamSD.
...
module sdram_bridge (
	...
	// l'istanziazione esistente in GundamSD.sv ma li ignoro internamente.
...
always @(*) begin
	reg [23:0] sub_word;
	sub_word = {1'b0, sub_byte_addr[23:1]};   // Gundam: sub port unused, base=0
